...
if not st.session_state.setup_complete:
    ...
    # Its important to note that we put 
...
# Show interview phase if setup is complete, feedback is not shown, and chat is not complete
...
# Show "Get Feedback" button if chat is complete
if st.session_state.chat_complete and not st.session_state.feedback_shown:
    if st.button("Get Feedback", on_click=show_feedback):
        st.write("Fetching feedback...")

# Show feedback screen if feedback is shown
